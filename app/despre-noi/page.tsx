...
export const metadata: Metadata = {
  title: 'Despre Drag Catering - Povestea Noastră | Restaurant și Catering Premium Iași',
  description: 'Descoperă povestea Drag Catering din Iași. Cu peste 15 ani de experiență în arta culinară, aducem autenticitatea gusturilor românești și rafinamentul bucătăriei internaționale.',
  keywords: 'despre drag catering, povestea restaurantului, catering iași istorie, echipa drag catering, experiență culinară iași, restaurant tradițional românesc',
  openGraph: {
    title: 'Despre Drag Catering - Povestea Unei Pasiuni Culinare în Iași',
    description: 'Cu peste 15 ani de experiență, Drag Catering combină tradițiile culinare românești cu inovațiile moderne. Descoperă valorile și misiunea noastră.',
    type: 'website',
    locale: 'ro_RO',
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Drag Catering - Interior elegant restaurant Iași',
      }
    ],
  },
  twitter: {
    ...
    title: 'Despre Drag Catering - Povestea Unei Pasiuni Culinare în Iași',
    description: 'Cu peste 15 ani de experiență în arta culinară, Drag Catering din Iași aduce autenticitate și rafinament.',
          ...
          <aside>
            <figure className="aspect-[4/3] rounded-3xl overflow-hidden">
              <Image 
                ...
                alt="Interior elegant al Restaurantului Drag Catering din Iași - atmosferă caldă și elegantă pentru evenimente speciale"
                width={800}
                height={600}
          ...
          <aside>
            <figure className="aspect-[4/3] rounded-3xl overflow-hidden">
              <Image 
                ...
                alt="Echipa profesională Drag Catering în bucătărie - bucătari experimentați pregătind preparate de calitate superioară"
                width={800}
                height={600}
                className="w-full h-full object-cover"
              />
